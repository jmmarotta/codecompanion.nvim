...
## [12.0.0](https://github.com/jmmarotta/codecompanion.nvim/compare/v14.5.0...v12.0.0) (2025-03-30)


### ⚠ BREAKING CHANGES

* **workspaces:** new workspace file format ([#1089](https://github.com/jmmarotta/codecompanion.nvim/issues/1089))
* **tools:** add queue and streamline implementation ([#965](https://github.com/jmmarotta/codecompanion.nvim/issues/965))

### Features

* :sparkles: add support for `snacks.nvim` ([#741](https://github.com/jmmarotta/codecompanion.nvim/issues/741)) ([5407aba](https://github.com/jmmarotta/codecompanion.nvim/commit/5407aba817d11c4e1f27da34210e4cd58e88a388))
* :sparkles: Agentic Workflows and much more ([#832](https://github.com/jmmarotta/codecompanion.nvim/issues/832)) ([f26fa4e](https://github.com/jmmarotta/codecompanion.nvim/commit/f26fa4eb8d0bd1ac0b0a2ab980839965db381fc2))
* :sparkles: can edit setting and message history ([#753](https://github.com/jmmarotta/codecompanion.nvim/issues/753)) ([2592d26](https://github.com/jmmarotta/codecompanion.nvim/commit/2592d26eb3da9462174c858464324c31eb35eb91))
* :sparkles: workspace slash command ([#702](https://github.com/jmmarotta/codecompanion.nvim/issues/702)) ([8173b5d](https://github.com/jmmarotta/codecompanion.nvim/commit/8173b5df1cd8da856b9449b4f68a8cd64d60f08d))
* [#604](https://github.com/jmmarotta/codecompanion.nvim/issues/604) `send_code` can be a function ([30b899e](https://github.com/jmmarotta/codecompanion.nvim/commit/30b899e638d5525494b64eacd19b1c0eb50f988c))
* adapter and debug window improvement ([be55c9b](https://github.com/jmmarotta/codecompanion.nvim/commit/be55c9b05d34940a15ad5aed70f62f04e333c7c4))
* **adapters:** add caching to adapters that make http calls to model endpoints ([#1145](https://github.com/jmmarotta/codecompanion.nvim/issues/1145)) ([9e779b2](https://github.com/jmmarotta/codecompanion.nvim/commit/9e779b2a4abfc154ba09f3a2d25bc684a413cefd))
* **adapters:** add claude 3.7 thought to copilot adapter ([#1001](https://github.com/jmmarotta/codecompanion.nvim/issues/1001)) ([6e53570](https://github.com/jmmarotta/codecompanion.nvim/commit/6e535709234e07995bacae08f267c0823457f1c5))
* **adapters:** add claude-3.7-sonnet and make default ([#996](https://github.com/jmmarotta/codecompanion.nvim/issues/996)) ([c207203](https://github.com/jmmarotta/codecompanion.nvim/commit/c207203a005baf0bd5bae3401ac202f568c60581))
* **adapters:** add claude-3.7-sonnet to copilot ([#1002](https://github.com/jmmarotta/codecompanion.nvim/issues/1002)) ([9729441](https://github.com/jmmarotta/codecompanion.nvim/commit/9729441037518c487a4a223165d463abcd1bdd67))
* **adapters:** add DeepSeek Adapter ([#683](https://github.com/jmmarotta/codecompanion.nvim/issues/683)) ([6668b5c](https://github.com/jmmarotta/codecompanion.nvim/commit/6668b5c517978207a7b00f3f5a9bc8c7760ebcad))
* **adapters:** add extended thinking and extended output for claude-3.7 ([#998](https://github.com/jmmarotta/codecompanion.nvim/issues/998)) ([a497adb](https://github.com/jmmarotta/codecompanion.nvim/commit/a497adb166fcfc29ef0a4fdad04bb0320e08e912))
* **adapters:** add gemini 2.5 pro option ([#1180](https://github.com/jmmarotta/codecompanion.nvim/issues/1180)) ([f134b6c](https://github.com/jmmarotta/codecompanion.nvim/commit/f134b6c8f35ea1df4fa45d4f50319554178308fb))
* **adapters:** add gemini-2.0-pro-exp-02-05 model option ([#1007](https://github.com/jmmarotta/codecompanion.nvim/issues/1007)) ([bef6d90](https://github.com/jmmarotta/codecompanion.nvim/commit/bef6d90a73652672c09b1b6323c8d5a0215020c0))
* **adapters:** add GitHub Models support ([#862](https://github.com/jmmarotta/codecompanion.nvim/issues/862)) ([4a6567b](https://github.com/jmmarotta/codecompanion.nvim/commit/4a6567b2a563503b157705ec284fb922f81b784a))
* **adapters:** add Mistral adapter ([#1118](https://github.com/jmmarotta/codecompanion.nvim/issues/1118)) ([e4754bb](https://github.com/jmmarotta/codecompanion.nvim/commit/e4754bb2501685721daa50ed843fb98af9d01725))
* **adapters:** add reasoning effort to copilot and openai ([#812](https://github.com/jmmarotta/codecompanion.nvim/issues/812)) ([b9a58eb](https://github.com/jmmarotta/codecompanion.nvim/commit/b9a58eb8f151f9771938105220d81c7577a52e0e))
* **adapters:** add support for novita ([#1136](https://github.com/jmmarotta/codecompanion.nvim/issues/1136)) ([d55dc41](https://github.com/jmmarotta/codecompanion.nvim/commit/d55dc41e380fffcf3f799d8ed7257ff7a6d51521))
* **adapters:** can hide default adapters ([#925](https://github.com/jmmarotta/codecompanion.nvim/issues/925)) ([f4b72d7](https://github.com/jmmarotta/codecompanion.nvim/commit/f4b72d746eb9549747e5236649306f5c56c1ae5a))
* **adapters:** dynamically get available models from copilot endpoint ([#1012](https://github.com/jmmarotta/codecompanion.nvim/issues/1012)) ([d62c8e1](https://github.com/jmmarotta/codecompanion.nvim/commit/d62c8e16291e113c877db8c6adc9ec45835b9a66))
* **adapters:** update `copilot` and `openai` adapters for o1 models ([c7ba92a](https://github.com/jmmarotta/codecompanion.nvim/commit/c7ba92ad367939e94bfa23df7e3eb1bc74909348))
* add new events ([9b85331](https://github.com/jmmarotta/codecompanion.nvim/commit/9b8533143e381fb0dd4e5c733217dac8f9852ea4))
* add reference handling to workflow processing ([#969](https://github.com/jmmarotta/codecompanion.nvim/issues/969)) ([4c9f120](https://github.com/jmmarotta/codecompanion.nvim/commit/4c9f120033c1c1b4c17536c2407c288d91d34e95))
* add symbols for scala ([#768](https://github.com/jmmarotta/codecompanion.nvim/issues/768)) ([4535cb5](https://github.com/jmmarotta/codecompanion.nvim/commit/4535cb5bdf92e3bc88d4cf061c606447131e27db))
* allow for full height chat windows when opening ([0e75d3b](https://github.com/jmmarotta/codecompanion.nvim/commit/0e75d3b9768e6a139bb2d51a1d05a6e2691171a8))
* allow for full height chat windows when opening ([5e00b43](https://github.com/jmmarotta/codecompanion.nvim/commit/5e00b432d9b340d4f189812945f6aab1edc00a51))
* blink completions on invoke, without trigger char ([#872](https://github.com/jmmarotta/codecompanion.nvim/issues/872)) ([51abcf1](https://github.com/jmmarotta/codecompanion.nvim/commit/51abcf1b4cfeb84c160f7589384b13636fa27e95))
* **chat:** :sparkles: can watch buffers ([176c13e](https://github.com/jmmarotta/codecompanion.nvim/commit/176c13e227cf39c4e22bec68d4631a8c47b643de))
* **chat:** :sparkles: LLM header name can now be a function ([#778](https://github.com/jmmarotta/codecompanion.nvim/issues/778)) ([5a82a54](https://github.com/jmmarotta/codecompanion.nvim/commit/5a82a5422494c44e6bbcf6c8afedacfe61659b03))
* **chat:** easier to add refs from external sources ([#960](https://github.com/jmmarotta/codecompanion.nvim/issues/960)) ([b7b43f6](https://github.com/jmmarotta/codecompanion.nvim/commit/b7b43f62ede6814fc5ab90d464016c63546d22a9))
* **chat:** hide system prompts by default ([#1113](https://github.com/jmmarotta/codecompanion.nvim/issues/1113)) ([161aaba](https://github.com/jmmarotta/codecompanion.nvim/commit/161aaba38b06bf76f03a35c92ae809f819b88766))
* **chat:** ui title is configurable ([8c93ab0](https://github.com/jmmarotta/codecompanion.nvim/commit/8c93ab0ecb031261d026cf3e8f7b84fe48b81f73))
* **completion:** auto setup blink.cmp ([90a6603](https://github.com/jmmarotta/codecompanion.nvim/commit/90a66033ffddb2f1daac0e5d23723214673ab0e5))
* **completion:** suggestions in blink have better score ([4317513](https://github.com/jmmarotta/codecompanion.nvim/commit/4317513cdb5fb7f35147448e3ca696756bf82cf2))
* **copilot:** add o3-mini support ([#810](https://github.com/jmmarotta/codecompanion.nvim/issues/810)) ([2816d12](https://github.com/jmmarotta/codecompanion.nvim/commit/2816d1244f0ce905c330fd9041d96ead51bbb0c2))
* **copilot:** add support for gemini 2.0 flash ([#855](https://github.com/jmmarotta/codecompanion.nvim/issues/855)) ([#856](https://github.com/jmmarotta/codecompanion.nvim/issues/856)) ([c0ea1c0](https://github.com/jmmarotta/codecompanion.nvim/commit/c0ea1c0faf57a61c1121532cad9bbeea58dcd0cc))
* **copilot:** add token count ([4fd26a6](https://github.com/jmmarotta/codecompanion.nvim/commit/4fd26a6fd9bc6aa4e88176350a05ff7e16b3a789))
* **deepseek:** [#692](https://github.com/jmmarotta/codecompanion.nvim/issues/692) [#669](https://github.com/jmmarotta/codecompanion.nvim/issues/669) show reasoning output ([#716](https://github.com/jmmarotta/codecompanion.nvim/issues/716)) ([b4467a1](https://github.com/jmmarotta/codecompanion.nvim/commit/b4467a1af36e8b99ffadc95dfed55154b18aebf8))
* **event:** add `CodeCompanionChatPin` event ([f86f4a7](https://github.com/jmmarotta/codecompanion.nvim/commit/f86f4a72dd154bb677d117e06cab9a9ee8d35f56))
* **events:** add strategy and adapter to payload ([#822](https://github.com/jmmarotta/codecompanion.nvim/issues/822)) ([b2e06de](https://github.com/jmmarotta/codecompanion.nvim/commit/b2e06de23f4b19f472ed97259260102fa7f9af0e))
* **events:** new request streaming event ([#878](https://github.com/jmmarotta/codecompanion.nvim/issues/878)) ([6846482](https://github.com/jmmarotta/codecompanion.nvim/commit/68464826515b764ebae5fdf28e4d3f8c01c80296))
* **inline:** new and improved assistant ([#904](https://github.com/jmmarotta/codecompanion.nvim/issues/904)) ([3e4fb61](https://github.com/jmmarotta/codecompanion.nvim/commit/3e4fb6176a9c1df456795a22891f865a2f4ee56a))
* **inline:** vars can now be callbacks closes [#1175](https://github.com/jmmarotta/codecompanion.nvim/issues/1175)  ([#1176](https://github.com/jmmarotta/codecompanion.nvim/issues/1176)) ([ccbaf20](https://github.com/jmmarotta/codecompanion.nvim/commit/ccbaf205d2d842dbef4c9ad9532576cf08fd4b1f))
* **prompts:** :sparkles: can now add references to the prompt library ([d5d86c9](https://github.com/jmmarotta/codecompanion.nvim/commit/d5d86c9af92555d2cafcb147573871445b8688b5))
* register source for filetype in blink.cmp ([#661](https://github.com/jmmarotta/codecompanion.nvim/issues/661)) ([2214916](https://github.com/jmmarotta/codecompanion.nvim/commit/2214916416dcf18741c65fe3afd034d0fe046263))
* **slash_cmd:** notify if no terminal buffer is found ([3687b88](https://github.com/jmmarotta/codecompanion.nvim/commit/3687b8807746700851f13a373ad6ead04bb082bd))
* **slash_cmds:** `buffer` slash command now sends line numbers ([25dab99](https://github.com/jmmarotta/codecompanion.nvim/commit/25dab9939e5065a59207d3b77eefc63e4b6e9fc0))
* **slash_cmds:** can be functions and modules ([#844](https://github.com/jmmarotta/codecompanion.nvim/issues/844)) ([59ea59e](https://github.com/jmmarotta/codecompanion.nvim/commit/59ea59e3c2bd336334b706a99446b792c32464bf))
* **slash_cmds:** remove git dependency for defualt provider ([#1042](https://github.com/jmmarotta/codecompanion.nvim/issues/1042)) ([a5c5a32](https://github.com/jmmarotta/codecompanion.nvim/commit/a5c5a3263ba825b7cd708597e541d2deac3c52f7))
* **slash_cmds:** terminal command only shows latest changes ([#898](https://github.com/jmmarotta/codecompanion.nvim/issues/898)) ([cde1882](https://github.com/jmmarotta/codecompanion.nvim/commit/cde18827e796f898b18899b5dbecf3badf72d2a9))
* **slash_command:** control system prompts in `/workspace` ([#736](https://github.com/jmmarotta/codecompanion.nvim/issues/736)) ([16d7f62](https://github.com/jmmarotta/codecompanion.nvim/commit/16d7f62239bea7b716b06c9ec588f977e054f90e))
* **symbols:** add Java support ([#1182](https://github.com/jmmarotta/codecompanion.nvim/issues/1182)) ([36ffd9c](https://github.com/jmmarotta/codecompanion.nvim/commit/36ffd9cd335afdc668e7bcc91ac6ae65149a4b2b))
* **tools:** `[@files](https://github.com/files)` tool can now read specific lines ([26c5b57](https://github.com/jmmarotta/codecompanion.nvim/commit/26c5b57aa80cb7a12baefa5a5a2e9cfe0a20126a))
* **tools:** `files` tool now uses search/replace block to edit text ([a02f6c7](https://github.com/jmmarotta/codecompanion.nvim/commit/a02f6c7bcbfdf955ca1c603b635cd9bc5baaaa7c))
* **tools:** allow passing a table as the `callback` of a tool. ([#936](https://github.com/jmmarotta/codecompanion.nvim/issues/936)) ([689ea6e](https://github.com/jmmarotta/codecompanion.nvim/commit/689ea6edbcdf0d1d16a90d41d5fa96cbdac4633f))
* **tools:** callbacks can be functions ([#1065](https://github.com/jmmarotta/codecompanion.nvim/issues/1065)) ([dff8a1c](https://github.com/jmmarotta/codecompanion.nvim/commit/dff8a1c969b66987923c14a305a654ea51b5e2a6))
* **tools:** function tools can update the agent status + doc updates ([#1074](https://github.com/jmmarotta/codecompanion.nvim/issues/1074)) ([e59c1f0](https://github.com/jmmarotta/codecompanion.nvim/commit/e59c1f04983edac15f195bfc73cd90bf08a3565b))
* **tools:** function-based tools can be async ([#1107](https://github.com/jmmarotta/codecompanion.nvim/issues/1107)) ([97636b9](https://github.com/jmmarotta/codecompanion.nvim/commit/97636b902ac20c665b0b3d9d5b2c62c16676e136))
* **tools:** when `stderr` is not empty, do not discard `stdout` when exit code is 0 ([#955](https://github.com/jmmarotta/codecompanion.nvim/issues/955)) ([d8de491](https://github.com/jmmarotta/codecompanion.nvim/commit/d8de491ebf2ed4bca7006ae33e6990ec3f8d60d0))
* **workspaces:** :sparkles: now supporting URLs ([#808](https://github.com/jmmarotta/codecompanion.nvim/issues/808)) ([5a1212d](https://github.com/jmmarotta/codecompanion.nvim/commit/5a1212d1124618853a6e39ecdc98c003619564f1))
* **workspaces:** handle multiple workflows better ([#806](https://github.com/jmmarotta/codecompanion.nvim/issues/806)) ([e463d65](https://github.com/jmmarotta/codecompanion.nvim/commit/e463d65ed4a5ba023acd58039b8f223eb82308c0))
* **workspaces:** new workspace file format ([#1089](https://github.com/jmmarotta/codecompanion.nvim/issues/1089)) ([3f7fd62](https://github.com/jmmarotta/codecompanion.nvim/commit/3f7fd6292b9d43d38e9760f43b581652210b0349))


### Bug Fixes

* [#698](https://github.com/jmmarotta/codecompanion.nvim/issues/698) custom variables ([#711](https://github.com/jmmarotta/codecompanion.nvim/issues/711)) ([104f913](https://github.com/jmmarotta/codecompanion.nvim/commit/104f91331979be7c44fa9b766b8356863ab955cd))
* [#732](https://github.com/jmmarotta/codecompanion.nvim/issues/732) can use deepseek with no config ([#733](https://github.com/jmmarotta/codecompanion.nvim/issues/733)) ([23d81a9](https://github.com/jmmarotta/codecompanion.nvim/commit/23d81a946e71c28cf2bdd025c1a3708f07f8d880))
* [#769](https://github.com/jmmarotta/codecompanion.nvim/issues/769) ollama adapter ([#793](https://github.com/jmmarotta/codecompanion.nvim/issues/793)) ([8a98c71](https://github.com/jmmarotta/codecompanion.nvim/commit/8a98c71cbdbde65230824c01d10eed262717c7a7))
* **adapter:** [#731](https://github.com/jmmarotta/codecompanion.nvim/issues/731) openai_compat adapter calling API too much ([#738](https://github.com/jmmarotta/codecompanion.nvim/issues/738)) ([184ca40](https://github.com/jmmarotta/codecompanion.nvim/commit/184ca40c1f802b7eb2b0dc5236dab56a10d9e96e))
* **adapter:** [#769](https://github.com/jmmarotta/codecompanion.nvim/issues/769) ollama adapter model not being expanded ([6a78557](https://github.com/jmmarotta/codecompanion.nvim/commit/6a78557b3fbd69a0f1dcec3e962c353b0b79db85))
* **adapters:** `on_exit` is called when request is cancelled ([#942](https://github.com/jmmarotta/codecompanion.nvim/issues/942)) ([df2c5f6](https://github.com/jmmarotta/codecompanion.nvim/commit/df2c5f6abe7a8e14eb792cf633fafee826d892a2))
* **adapters:** `openai_compatible` no longer forces schema ([#914](https://github.com/jmmarotta/codecompanion.nvim/issues/914)) ([ba06239](https://github.com/jmmarotta/codecompanion.nvim/commit/ba0623998febc50859b172bfd7c8fe8bf180a22b)), closes [#918](https://github.com/jmmarotta/codecompanion.nvim/issues/918)
* **adapters:** add mistral to the config ([#1133](https://github.com/jmmarotta/codecompanion.nvim/issues/1133)) ([fbb0e1d](https://github.com/jmmarotta/codecompanion.nvim/commit/fbb0e1d0ccdd2eaa16ea9ba0f94ca8e4c64f5b97))
* **adapters:** anthropic inline editing ([#1142](https://github.com/jmmarotta/codecompanion.nvim/issues/1142)) ([ad99cda](https://github.com/jmmarotta/codecompanion.nvim/commit/ad99cdaca4df56bb3db5ac0a17b423740ce0396d))
* **adapters:** copilot token issue when changing adapter closes [#1149](https://github.com/jmmarotta/codecompanion.nvim/issues/1149) ([#1155](https://github.com/jmmarotta/codecompanion.nvim/issues/1155)) ([0cc0541](https://github.com/jmmarotta/codecompanion.nvim/commit/0cc054199c20416da45bdbcadd10b3a9ea748557))
* **adapters:** dynamically getting copilot adapters when switching adapters ([c0a820e](https://github.com/jmmarotta/codecompanion.nvim/commit/c0a820e0184ac0714c608b06fd3822abe79492cb))
* **adapters:** ensure cache_expires is set ([#1146](https://github.com/jmmarotta/codecompanion.nvim/issues/1146)) ([5d6e3c5](https://github.com/jmmarotta/codecompanion.nvim/commit/5d6e3c5ad3436e1d0baca6588e96426e11f105e2))
* **adapters:** handle multiline userdata in copilot adapter ([#770](https://github.com/jmmarotta/codecompanion.nvim/issues/770)) ([4282c68](https://github.com/jmmarotta/codecompanion.nvim/commit/4282c68476f60ea9328790508ff3b191b6ec512b))
* **adapters:** inline editing with copilot closes [#1036](https://github.com/jmmarotta/codecompanion.nvim/issues/1036) [#1027](https://github.com/jmmarotta/codecompanion.nvim/issues/1027) ([#1037](https://github.com/jmmarotta/codecompanion.nvim/issues/1037)) ([aae4ad7](https://github.com/jmmarotta/codecompanion.nvim/commit/aae4ad785dea43b1adfb2d0c0c6b546fe09c1819))
* **adapters:** max_tokens error with anthropic ([#1031](https://github.com/jmmarotta/codecompanion.nvim/issues/1031)) ([59c9109](https://github.com/jmmarotta/codecompanion.nvim/commit/59c91098f967ffd57f7ae90846a6f751d1c96d2d))
* **adapters:** only try and replace str variables ([#999](https://github.com/jmmarotta/codecompanion.nvim/issues/999)) ([c5990b4](https://github.com/jmmarotta/codecompanion.nvim/commit/c5990b43d0801438aac4afaef7a779ff98297a85))
* **adapters:** openai_compatible hardcoded models endpoint closes [#1022](https://github.com/jmmarotta/codecompanion.nvim/issues/1022) ([#1038](https://github.com/jmmarotta/codecompanion.nvim/issues/1038)) ([4585695](https://github.com/jmmarotta/codecompanion.nvim/commit/4585695d2537ccc4cf9b14bc5559b6c29353a588))
* **adapters:** remove `tfs_z` from Ollama schema ([#1152](https://github.com/jmmarotta/codecompanion.nvim/issues/1152)) ([52e2969](https://github.com/jmmarotta/codecompanion.nvim/commit/52e296963a0a8e6414c0ec72f6bc687b16f2eca7))
* **adapters:** replace vars on every request closes [#1052](https://github.com/jmmarotta/codecompanion.nvim/issues/1052) ([#1054](https://github.com/jmmarotta/codecompanion.nvim/issues/1054)) ([942fd80](https://github.com/jmmarotta/codecompanion.nvim/commit/942fd80b82d7059fa6fe494adea0b15168302e54))
* **adapter:** variable substitution in 'raw'. ([#980](https://github.com/jmmarotta/codecompanion.nvim/issues/980)) ([6c628f5](https://github.com/jmmarotta/codecompanion.nvim/commit/6c628f56419ce8cca7b93cfaba89cde90a3a3a51))
* allow for multiple completions in a single line ([3516e46](https://github.com/jmmarotta/codecompanion.nvim/commit/3516e46a62ebb151e6fa0afe4ac631432994cc3a))
* **anthropic:** inline editing closes [#1127](https://github.com/jmmarotta/codecompanion.nvim/issues/1127) ([#1130](https://github.com/jmmarotta/codecompanion.nvim/issues/1130)) ([bc89f11](https://github.com/jmmarotta/codecompanion.nvim/commit/bc89f118f1991e9be24c784f72f57f373aa6f84b))
* **blink:** [#587](https://github.com/jmmarotta/codecompanion.nvim/issues/587) slash commands ([1b8ab18](https://github.com/jmmarotta/codecompanion.nvim/commit/1b8ab18cd0be76f13d13e6deaa56e6c33dce5a23))
* **blink:** add support to blink newer than 0.13.1 ([#1139](https://github.com/jmmarotta/codecompanion.nvim/issues/1139)) ([3ee07d6](https://github.com/jmmarotta/codecompanion.nvim/commit/3ee07d6805d85ddd9c97715af5bc79c8e7f2adb1))
* **blink:** cursor put at wrong position after accepting ([#1179](https://github.com/jmmarotta/codecompanion.nvim/issues/1179)) ([f83641b](https://github.com/jmmarotta/codecompanion.nvim/commit/f83641ba9e3a8993afb03a856701623c746a05b8))
* **blink:** slash commands leaving brackes in chat buffer ([820bc52](https://github.com/jmmarotta/codecompanion.nvim/commit/820bc52c7b4a5a494773a3aa4e25e9e36659e378))
* **chat:** [#622](https://github.com/jmmarotta/codecompanion.nvim/issues/622) parse messages when `show_header_separator` is on ([6040ce4](https://github.com/jmmarotta/codecompanion.nvim/commit/6040ce4b45e0b9378e4c51c2d86cf5f40b2af2c5))
* **chat:** [#783](https://github.com/jmmarotta/codecompanion.nvim/issues/783) display settings in chat buffer ([#784](https://github.com/jmmarotta/codecompanion.nvim/issues/784)) ([cd712c5](https://github.com/jmmarotta/codecompanion.nvim/commit/cd712c5cafe9fcf2d17c5564bb2bd0141b16f15d))
* **chat:** [#814](https://github.com/jmmarotta/codecompanion.nvim/issues/814) `show_header_separator` ([#816](https://github.com/jmmarotta/codecompanion.nvim/issues/816)) ([38793d3](https://github.com/jmmarotta/codecompanion.nvim/commit/38793d32f2d00df580e7648f7e8109817bc70855))
* **chat:** [#887](https://github.com/jmmarotta/codecompanion.nvim/issues/887) header separator is now detected ([#902](https://github.com/jmmarotta/codecompanion.nvim/issues/902)) ([63e76c5](https://github.com/jmmarotta/codecompanion.nvim/commit/63e76c580d49eb30c147594a8bf9ca50f145f8f7))
* **chat:** [#889](https://github.com/jmmarotta/codecompanion.nvim/issues/889) pinned file references always have same id ([#890](https://github.com/jmmarotta/codecompanion.nvim/issues/890)) ([cbac9bc](https://github.com/jmmarotta/codecompanion.nvim/commit/cbac9bc6552a0eb3c3b6b0a64adb5ddd71617dbc))
* **chat:** [#906](https://github.com/jmmarotta/codecompanion.nvim/issues/906) ignore system prompt now works ([#909](https://github.com/jmmarotta/codecompanion.nvim/issues/909)) ([4d0e4dd](https://github.com/jmmarotta/codecompanion.nvim/commit/4d0e4dd80016a63ffcf28953ba13da72a1ccd953))
* **chat:** [#915](https://github.com/jmmarotta/codecompanion.nvim/issues/915) parsing show_settings when InsertLeave is executed ([#916](https://github.com/jmmarotta/codecompanion.nvim/issues/916)) ([1103551](https://github.com/jmmarotta/codecompanion.nvim/commit/1103551e8ba5772522422017ca618a65d385db2c))
* **chat:** agent's tools are no displayed individually ([d889210](https://github.com/jmmarotta/codecompanion.nvim/commit/d889210fd2c536940fb57ec0ad90d018e76c275c))
* **chat:** always strip references from messages ([4c91a46](https://github.com/jmmarotta/codecompanion.nvim/commit/4c91a46136b6db99880c694313c9cabee24bd715))
* **chat:** better cancelling of requests ([#828](https://github.com/jmmarotta/codecompanion.nvim/issues/828)) ([84e8098](https://github.com/jmmarotta/codecompanion.nvim/commit/84e80986e2915a003f1609d8e3107d7046c6e3b8))
* **chat:** can debug adapters with `schema.model.default` as a function ([#797](https://github.com/jmmarotta/codecompanion.nvim/issues/797)) ([fbb15a8](https://github.com/jmmarotta/codecompanion.nvim/commit/fbb15a8b10d203c8c4df5fb938d5c9ac841725fa))
* **chat:** can set system prompt dynamically when switching adapters closes [#1033](https://github.com/jmmarotta/codecompanion.nvim/issues/1033) ([#1077](https://github.com/jmmarotta/codecompanion.nvim/issues/1077)) ([b76a47a](https://github.com/jmmarotta/codecompanion.nvim/commit/b76a47a62383dcf22dd41839467ea37d2e82ee59))
* **chat:** change deepseek models ([7e211d5](https://github.com/jmmarotta/codecompanion.nvim/commit/7e211d522d0cf1f8cbd3b5f25d486e80f4276693))
* **chat:** changing adapter in empty chat w/o system prompt ([#616](https://github.com/jmmarotta/codecompanion.nvim/issues/616)) ([3e64e6c](https://github.com/jmmarotta/codecompanion.nvim/commit/3e64e6c89af1c3e841bbd59b67265f475983c164))
* **chat:** changing adapters for models with table type ([3a961bb](https://github.com/jmmarotta/codecompanion.nvim/commit/3a961bb2df0dd9245bdf2c9cc2e3fcdb7d9f3654))
* **chat:** debug window height and width asfunctions ([#926](https://github.com/jmmarotta/codecompanion.nvim/issues/926)) ([1d67908](https://github.com/jmmarotta/codecompanion.nvim/commit/1d67908153855bacc28a766ecb0903c68f14b2d8)), closes [#905](https://github.com/jmmarotta/codecompanion.nvim/issues/905)
* **chat:** incorrectly applying settings ([#881](https://github.com/jmmarotta/codecompanion.nvim/issues/881)) ([2b0fe19](https://github.com/jmmarotta/codecompanion.nvim/commit/2b0fe199ca7d4b38895a8ab29b6320ca877809c6))
* **chat:** message editing for adapters with model schema as a function ([b6dcc37](https://github.com/jmmarotta/codecompanion.nvim/commit/b6dcc378c95014b0a3e62593c9150f682206e61f))
* **chat:** more graceful cancellations ([#739](https://github.com/jmmarotta/codecompanion.nvim/issues/739)) ([05c8853](https://github.com/jmmarotta/codecompanion.nvim/commit/05c8853ff0ff931a0daed569367d69524c792292))
* **chat:** navigate between H2 headers in buffer only ([#781](https://github.com/jmmarotta/codecompanion.nvim/issues/781)) ([391aeae](https://github.com/jmmarotta/codecompanion.nvim/commit/391aeae6b0dbbe6e4d31bd0ac77a25fefa0ea9de))
* **chat:** prevent duplicate references ([fb6444b](https://github.com/jmmarotta/codecompanion.nvim/commit/fb6444b739c01c2009a6adb6dbeea23c425b4c7c))
* **chat:** references not being added with `show_header_separators` closes [#1067](https://github.com/jmmarotta/codecompanion.nvim/issues/1067) ([#1069](https://github.com/jmmarotta/codecompanion.nvim/issues/1069)) ([9cd4094](https://github.com/jmmarotta/codecompanion.nvim/commit/9cd4094e5ccc428faae487568aabeb4873393f1b))
* **chat:** show tools and groups in helper window ([#1062](https://github.com/jmmarotta/codecompanion.nvim/issues/1062)) ([baa283e](https://github.com/jmmarotta/codecompanion.nvim/commit/baa283efe3ecf8d1d5183b10ac3cdfae2c9c8820))
* **chat:** update system prompt to avoid using h1 and h2 headers ([#1084](https://github.com/jmmarotta/codecompanion.nvim/issues/1084)) ([8f53a3a](https://github.com/jmmarotta/codecompanion.nvim/commit/8f53a3ab541545fdf325bb0dc3bec1de7207aab6))
* **cmp:** extend default sources ([8b0ebb4](https://github.com/jmmarotta/codecompanion.nvim/commit/8b0ebb4092c3266746663443d1b8dff13e3ba723))
* **completion:** [#597](https://github.com/jmmarotta/codecompanion.nvim/issues/597) blink configuration ([a1166d5](https://github.com/jmmarotta/codecompanion.nvim/commit/a1166d5a2e9249f81060d328859382be57eae79d))
* **completion:** blink.cmp failing for slash commands ([6dd3309](https://github.com/jmmarotta/codecompanion.nvim/commit/6dd3309e6761d7ae8cbda386781eb48354f00db2))
* **completion:** disable default execute implementation for blink.cmp ([#1137](https://github.com/jmmarotta/codecompanion.nvim/issues/1137)) ([b88684d](https://github.com/jmmarotta/codecompanion.nvim/commit/b88684d97af444947cedaeda9cc7ba0205b0d3b4))
* **copilot:** show token output in chat ([6908fd7](https://github.com/jmmarotta/codecompanion.nvim/commit/6908fd71b589c9a4813f2dad9f460a6368003617))
* **deepseek:** [#760](https://github.com/jmmarotta/codecompanion.nvim/issues/760) tooling and update adapter utils ([3d3b1a1](https://github.com/jmmarotta/codecompanion.nvim/commit/3d3b1a1f5deb5e06a86d67a9b792a263ea8e9191))
* **deepseek:** messages order ([#700](https://github.com/jmmarotta/codecompanion.nvim/issues/700)) ([c911a8e](https://github.com/jmmarotta/codecompanion.nvim/commit/c911a8e6f0bc87f557587cc60b2af27d6151ad19))
* **deepseek:** reasoning output closes [#1091](https://github.com/jmmarotta/codecompanion.nvim/issues/1091) ([#1095](https://github.com/jmmarotta/codecompanion.nvim/issues/1095)) ([bcdfa2b](https://github.com/jmmarotta/codecompanion.nvim/commit/bcdfa2b15232058964c53856cfbf736988ba0066))
* delete diff buffers instead of closing ([#852](https://github.com/jmmarotta/codecompanion.nvim/issues/852)) ([4c48bd3](https://github.com/jmmarotta/codecompanion.nvim/commit/4c48bd336e900ed7bf3be95689ac1cc147b3701e))
* **http:** prevent model from no schema.model ([#839](https://github.com/jmmarotta/codecompanion.nvim/issues/839)) ([abaf645](https://github.com/jmmarotta/codecompanion.nvim/commit/abaf645cfcb64bddc8f9124fb4bf71999372e752))
* **inline:** [#613](https://github.com/jmmarotta/codecompanion.nvim/issues/613) negative column indexing ([977a521](https://github.com/jmmarotta/codecompanion.nvim/commit/977a521d1a3780d2278d1f175e37ca439b10a372))
* **inline:** [#688](https://github.com/jmmarotta/codecompanion.nvim/issues/688) end_col out of range ([6d2a477](https://github.com/jmmarotta/codecompanion.nvim/commit/6d2a47753d25872ceaaafe9968ed6e3d2ed06bbd))
* **inline:** ensure placement is in lower case ([#949](https://github.com/jmmarotta/codecompanion.nvim/issues/949)) ([04019d5](https://github.com/jmmarotta/codecompanion.nvim/commit/04019d5aefd70c7d44031c97e2f2126b6ed408af))
* **inline:** setting placement from prompt library closes [#990](https://github.com/jmmarotta/codecompanion.nvim/issues/990) ([#991](https://github.com/jmmarotta/codecompanion.nvim/issues/991)) ([836dafc](https://github.com/jmmarotta/codecompanion.nvim/commit/836dafca125ec713f8a9379c69319f7889504824))
* **inline:** tweak system prompt ([#754](https://github.com/jmmarotta/codecompanion.nvim/issues/754)) ([4985375](https://github.com/jmmarotta/codecompanion.nvim/commit/4985375c6256498ff6991179404557c16118568a))
* logging in plugin ([#786](https://github.com/jmmarotta/codecompanion.nvim/issues/786)) ([ec30170](https://github.com/jmmarotta/codecompanion.nvim/commit/ec301700c01414abbe7bfb7883b80ebb9255762b))
* **ollama:** allow users to customize the authorization header in get_models closes [#976](https://github.com/jmmarotta/codecompanion.nvim/issues/976) ([#985](https://github.com/jmmarotta/codecompanion.nvim/issues/985)) ([a4f1046](https://github.com/jmmarotta/codecompanion.nvim/commit/a4f1046e26e1ca537fcc21b881051c41f00e337c))
* **openai:** [#619](https://github.com/jmmarotta/codecompanion.nvim/issues/619) o1 streaming ([83786d8](https://github.com/jmmarotta/codecompanion.nvim/commit/83786d878ebf46b50ae0a3717ad033934a80a390))
* **openai:** [#619](https://github.com/jmmarotta/codecompanion.nvim/issues/619) o1 streaming ([8bfb496](https://github.com/jmmarotta/codecompanion.nvim/commit/8bfb49633b6cd9194807856636b6b63047a06ac4))
* **openai:** [#892](https://github.com/jmmarotta/codecompanion.nvim/issues/892) handle different finish reasons ([#893](https://github.com/jmmarotta/codecompanion.nvim/issues/893)) ([70179b0](https://github.com/jmmarotta/codecompanion.nvim/commit/70179b00092a1ab45114448b256bb02c2fdb34de))
* **openai:** model streaming ([#896](https://github.com/jmmarotta/codecompanion.nvim/issues/896)) ([28a03a3](https://github.com/jmmarotta/codecompanion.nvim/commit/28a03a38c7f9019fd303614d1d42b4539f324b97))
* **prompts:** do not ignore user prompt ([#1110](https://github.com/jmmarotta/codecompanion.nvim/issues/1110)) ([5ee7873](https://github.com/jmmarotta/codecompanion.nvim/commit/5ee7873342e254828963930e5c9e922c8d978211))
* **slash_cmd:** improve symbols notifcations ([e6b36b4](https://github.com/jmmarotta/codecompanion.nvim/commit/e6b36b4448cb12215fb74372ce9868f61e046bea))
* **slash_cmds:** `file` slash command will show hidden files with telescope ([39c7ca0](https://github.com/jmmarotta/codecompanion.nvim/commit/39c7ca07918999fa5daf8ef344a4490befa56858))
* **slash_cmds:** add spacing to `/fetch` input ([#953](https://github.com/jmmarotta/codecompanion.nvim/issues/953)) ([5f3332b](https://github.com/jmmarotta/codecompanion.nvim/commit/5f3332bb86a5c6afefb11659db3d78c11350cb66))
* **slash_command:** create cache folder on windows for `/fetch` ([#756](https://github.com/jmmarotta/codecompanion.nvim/issues/756)) ([223e35f](https://github.com/jmmarotta/codecompanion.nvim/commit/223e35f8150f49a16ec19c966d822594c2bcf4b7))
* **slash_commands:** [#803](https://github.com/jmmarotta/codecompanion.nvim/issues/803) mini_pick provider ([#804](https://github.com/jmmarotta/codecompanion.nvim/issues/804)) ([4a895b9](https://github.com/jmmarotta/codecompanion.nvim/commit/4a895b9f4385e8c04dd70411c3628423dfd6b8a6))
* **slash_commands:** handle no content in `terminal` slash command ([aae2085](https://github.com/jmmarotta/codecompanion.nvim/commit/aae208550ade2d1cbcfaada2c72aeeee83b989b0))
* **slash_commands:** scope constants to be local ([#787](https://github.com/jmmarotta/codecompanion.nvim/issues/787)) ([7daf143](https://github.com/jmmarotta/codecompanion.nvim/commit/7daf143c46c9710697ee3e17f2043664c0859951))
* **slash_command:** stop double wrapping output from `fetch` ([c53a917](https://github.com/jmmarotta/codecompanion.nvim/commit/c53a917803888458ba7955e52870353345c9c48c))
* **slash_command:** typescript ft not recognised ([#723](https://github.com/jmmarotta/codecompanion.nvim/issues/723)) ([c114e42](https://github.com/jmmarotta/codecompanion.nvim/commit/c114e4203d858aef99a835280e02a67a6d0d9082))
* **tool:** output handler can be any type ([#1106](https://github.com/jmmarotta/codecompanion.nvim/issues/1106)) ([8823590](https://github.com/jmmarotta/codecompanion.nvim/commit/8823590f3cb251eb09315682bb3f40abf212969b))
* **tools:** [@files](https://github.com/files) tool reject causes error ([#1082](https://github.com/jmmarotta/codecompanion.nvim/issues/1082)) ([e9e7b26](https://github.com/jmmarotta/codecompanion.nvim/commit/e9e7b26187e3574a41aa09330e6dd4bb28c1fa9e))
* **tools:** add missing write flag attribute when editing files ([#966](https://github.com/jmmarotta/codecompanion.nvim/issues/966)) ([d5bc944](https://github.com/jmmarotta/codecompanion.nvim/commit/d5bc9441d55a9e6f81191ec96871ae4a48890997))
* **tools:** better error handling ([0d8de44](https://github.com/jmmarotta/codecompanion.nvim/commit/0d8de4456c67a8867688497787d3794d5e09e751))
* **tools:** can now chain jobs effectively ([#945](https://github.com/jmmarotta/codecompanion.nvim/issues/945)) ([2bab6d7](https://github.com/jmmarotta/codecompanion.nvim/commit/2bab6d78a3c4b05e852c80cadb13fbc8b1e0c99f))
* **tools:** make stderr capturing work for "streaming" output ([#943](https://github.com/jmmarotta/codecompanion.nvim/issues/943)) ([199824e](https://github.com/jmmarotta/codecompanion.nvim/commit/199824e89b0c459cc489d176aac60ce6c909d5a1))
* **tools:** output correctly in the chat buffer ([3a6acfb](https://github.com/jmmarotta/codecompanion.nvim/commit/3a6acfbc52989848b8264fe415380747a9af5615))
* **ui:** render settings ([#1047](https://github.com/jmmarotta/codecompanion.nvim/issues/1047)) ([6bcebbf](https://github.com/jmmarotta/codecompanion.nvim/commit/6bcebbfaccb4fed649bf901bac3654373dece54c))
* use slash commands with `:CodeCompanion` cmd ([8cbf696](https://github.com/jmmarotta/codecompanion.nvim/commit/8cbf6960960bf386d85badad99152bf021554986))
* **utils:** parse "boolean_scalar" fields when decoding yaml ([#635](https://github.com/jmmarotta/codecompanion.nvim/issues/635)) ([3bf8cac](https://github.com/jmmarotta/codecompanion.nvim/commit/3bf8cacd5298dfa1b103c52d8fd460b0be3b2d08))
* **workspaces:** add description to urls from cache and check they exist ([#900](https://github.com/jmmarotta/codecompanion.nvim/issues/900)) ([2d08176](https://github.com/jmmarotta/codecompanion.nvim/commit/2d0817684206b6caa17c72c2a58d3e21641d96fe))
* **workspaces:** workspace path constant cleared after first use ([#761](https://github.com/jmmarotta/codecompanion.nvim/issues/761)) ([b39acc1](https://github.com/jmmarotta/codecompanion.nvim/commit/b39acc15dfdf057f6e7f2d0b87e0183d3d151409))
* **yaml:** handle nil values in show_settings ([9b44789](https://github.com/jmmarotta/codecompanion.nvim/commit/9b447897320ee149531b6d6d8f90b25d97880666))


### Performance Improvements

* **chat:** [#552](https://github.com/jmmarotta/codecompanion.nvim/issues/552) improve settings tree-sitter query ([#708](https://github.com/jmmarotta/codecompanion.nvim/issues/708)) ([c7e54d2](https://github.com/jmmarotta/codecompanion.nvim/commit/c7e54d28cc29e7cd2b221b585b90640c7fa21483))
* **http:** improve resiliency of requests ([d99928b](https://github.com/jmmarotta/codecompanion.nvim/commit/d99928b5503788651b0b67bb3a577746763c7349))


### Miscellaneous Chores

* **main:** release 11.13.0 ([#687](https://github.com/jmmarotta/codecompanion.nvim/issues/687)) ([2051d27](https://github.com/jmmarotta/codecompanion.nvim/commit/2051d2707efb281b147dd883b42b23ad5bd4ed14))
* release 11.12.1 ([fe73840](https://github.com/jmmarotta/codecompanion.nvim/commit/fe73840fdc18459715d0d67a4f2685a654c17385))


### Code Refactoring

* **tools:** add queue and streamline implementation ([#965](https://github.com/jmmarotta/codecompanion.nvim/issues/965)) ([acd48ef](https://github.com/jmmarotta/codecompanion.nvim/commit/acd48eff972e334bb863c6b083db90c7fcb0b053))
